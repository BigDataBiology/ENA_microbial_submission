...
def main(input_file, study, reads, output_prefix):
    ...
    for i in range(len(data_table)):
        ...
        library_selection_tag = ET.SubElement(library_descriptor_tag, 'LIBRARY_SELECTION')
        ...
        platform_info_tag = ET.SubElement(platform_tag, current_sample['platform'].upper())
        ...
        experiment_attributes_tag = ET.SubElement(experiment_tag, 'EXPERIMENT_ATTRIBUTES')
    ...
    for i in range(len(data_table)):
        ...
        r1_file = [file for file in reads_dict[current_sample['alias']] if file.endswith('1.fastq.gz')][0]
        ...
        r2_file = [file for file in reads_dict[current_sample['alias']] if file.endswith('2.fastq.gz')][0]
